...
class AdminController extends AbstractController
{
    ...
    {
        return $this->forward('App\Controller\SecurityController::login', ['authenticationUtils' => $authenticationUtils]);
    }
    ...
    {
        return $this->forward('App\Controller\PageController::new',['request' => $request, 'entityManager', $entityManager]);
    }
    #[Route('/admin/pages/{id<\d+>}', name: 'app_admin_page_show', methods: ['GET'])]
    public function showPage(Page $page): Response{
        return $this->forward('App\Controller\PageController::show', ['page' => $page]);
    }
    ...
    {
        return $this->forward('App\Controller\PageController::delete', ['request'=> $request, 'page' => $page, 'entityManager' => $entityManager]);
    }
}
